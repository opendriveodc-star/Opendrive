// Auto-generated – đừng sửa tay
// jsQR bundled offline để scan QR từ ảnh mà không cần internet
export const QR_SCANNER_HTML = `<!DOCTYPE html><html><head><meta charset="utf-8"></head>
<body style="margin:0"><canvas id="c" style="display:none"></canvas>
<script>
...
<script>
window.scanBase64=function(b64,mime){
  var img=new Image();
  img.onload=function(){
