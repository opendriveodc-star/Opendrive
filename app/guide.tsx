...
const GUIDE: Record<Tab, Record<'vi' | 'en', GuideStep[]>> = {
  driver: {
    vi: [
      ...
      { icon: 'navigate-outline',        title: 'Thực hiện chuyến',         body: 'Sau khi khách chọn bạn, nhận thông báo xác nhận. Dẫn đường qua Google Maps tích hợp. Vị trí của bạn tự động cập nhật lên bản đồ cho khách theo dõi.' },
      ...
      { icon: 'wallet-outline',          title: 'Ví ODC',                   body: 'Xem số dư trong mục Ví ODC. Nhận thưởng 10 ODC khi tài xế bạn giới thiệu hoàn thành chuyến đầu tiên. ODC dùng để đảm bảo chất lượng dịch vụ.' },
    ],
    en: [
      ...
      { icon: 'navigate-outline',        title: 'Complete the ride',        body: 'After the passenger selects you, receive a confirmation. Navigate via the integrated Google Maps link. Your location updates automatically on the map for the passenger to track.' },
      ...
      { icon: 'wallet-outline',          title: 'ODC Wallet',               body: 'Check your balance in the ODC Wallet section. Earn 10 ODC when a driver you referred completes their first trip. ODC ensures service quality.' },
    ],
  },
  customer: {
    vi: [
      ...
      { icon: 'map-outline',             title: 'Theo dõi tài xế',          body: 'Xem vị trí tài xế trên bản đồ thời gian thực. Nhận thông báo khi tài xế đến nơi đón.' },
    ...
    en: [
      ...
      { icon: 'map-outline',             title: 'Track your driver',        body: 'Watch your driver\'s real-time location on the map. You\'ll be notified when the driver arrives at the pickup point.' },
